...
class CommentRepositoryTest {
    ...
    void findByNickName() {
        /* Case 1 : "Park"의 모든 댓글 조회 */
        {
            ...
            //3.예상 데이터
            Comment a = new Comment(1L, new Article(4L,"당신의 인생 영화는?","댓글 Go"),
                    nickname, "굿 윌 헌팅");
            Comment b = new Comment(4L, new Article(5L,"당신의 소울푸드는?","댓글 Go Go"),
                    nickname, "치킨");
            Comment c = new Comment(7L, new Article(6L,"당신의 취미는?","댓글 Go Go Go"),
                    nickname, "조깅");
        ...
        /* Case 2 : "Kim"의 모든 댓글 조회 */
        {
            ...
            List<Comment> comments = commentRepository.findByNickName(nickname);
            //3.예상 데이터
            Comment a = new Comment(2L, new Article(4L,"당신의 인생 영화는?","댓글 Go"),
                    nickname, "아이 엠 샘");
            Comment b = new Comment(5L, new Article(5L,"당신의 소울푸드는?","댓글 Go Go"),
                    nickname, "샤브샤브");
            Comment c = new Comment(8L, new Article(6L,"당신의 취미는?","댓글 Go Go Go"),
                    nickname, "유튜브 시청");
